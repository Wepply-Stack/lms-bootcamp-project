...
from .serializers import CourseSerializer, CourseUpdateSerializer, LessonSerializer, MaterialSerializer, FileUploadSerializer, FILE_TYPE
...
class MaterialViewSet(viewsets.ViewSet):
    ...
    def destroy(self, request, course_id=None, pk=None):
        course = get_object_or_404(Course, id=course_id)
        material = get_object_or_404(Material, id=pk, course=course)
