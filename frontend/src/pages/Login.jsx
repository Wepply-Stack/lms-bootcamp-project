    ...
    <div className="flex h-screen w-screen overflow-hidden">
      ...
      <div className="hidden lg:flex lg:flex-1 bg-green-950 items-center justify-center flex-col">
        <div className="flex flex-col items-start px-8 lg:px-12">
          ...
          <h2 className="text-green-100 text-2xl lg:text-3xl pb-4">
            Unlock your Learning Potential
          </h2>
          <p className="text-green-100 text-lg lg:text-xl m-0 p-0 text-left">
            Sign in to continue your journey of growth and kowledge. Explore
            courses, track progress and achieve your goals
          </p>
        </div>
      </div>
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 lg:p-10 shadow-2xl shadow-black/60">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                <a
                  href="#"
                  className="text-xs text-green-500/80 hover:text-amber-400 transition-colors tracking-wide"
                >
                  Forgot password?
                </a>
              </div>
              ...
              >
                <span
                  className={`transition-all duration-200 ${loading ? "opacity-0" : "opacity-100"}`}
                >
                  Sign In
                </span>
                {loading && (
                  <span className="absolute inset-0 flex items-center justify-center">
                    <svg
                      className="animate-spin w-5 h-5 text-green-950"
                      fill="none"
                      viewBox="0 0 24 24"
                    >
                      <circle
